<template>
  <form @submit.prevent="submitForm">
    ...
    >
      ...
      />
      <p v-if="!firstName.isValid">First Name must not me empty</p>
    </div>
    <div
      class="form-control"
      :class="{
    ...
    >
      ...
      />
      <p v-if="!lastName.isValid">Last Name must not me empty</p>
    </div>
    <div
      class="form-control"
      :class="{
    ...
    >
      ...
      />
      <p v-if="!description.isValid">Description must not me empty</p>
    </div>
    <div
      class="form-control"
      :class="{
        invalid: !rate.isValid,
      }"
    >
